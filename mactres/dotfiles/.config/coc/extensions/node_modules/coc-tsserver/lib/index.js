...
var init_main = __esm({
  "node_modules/vscode-languageserver-types/lib/esm/main.js"() {
    ...
    EOL = ["\n", "\r\n", "\r"];
    (function(TextDocument20) {
      function create(uri, languageId, version, content) {
        return new FullTextDocument(uri, languageId, version, content);
      }
      TextDocument20.create = create;
      function is(value) {
        var candidate = value;
        return Is.defined(candidate) && Is.string(candidate.uri) && (Is.undefined(candidate.languageId) || Is.string(candidate.languageId)) && Is.uinteger(candidate.lineCount) && Is.func(candidate.getText) && Is.func(candidate.positionAt) && Is.func(candidate.offsetAt) ? true : false;
      }
      TextDocument20.is = is;
      ...
      TextDocument20.applyEdits = applyEdits;
...
var BufferSynchronizer = class {
  ...
  flush() {
    ...
    if (this._pending.size > 0) {
      ...
      this.client.execute("updateOpen", { changedFiles, closedFiles, openFiles }, import_vscode_languageserver_protocol14.CancellationToken.None, { nonRecoverable: true }).catch((e) => {
...
var BufferSyncSupport = class {
  ...
  openTextDocument(document) {
    ...
    const filepath = this.client.toTsFilePath(import_coc34.Uri.parse(resource));
    if (!filepath) {
      return false;
    }
    if (this.syncedBuffers.has(resource)) {
...
var TypeScriptVersion = class {
  ...
  get tscPath() {
    return import_path11.default.resolve(this.path, `../bin/tsc${process.platform == "win32" ? ".exe" : ""}`);
  }
  get tsServerPath() {
...
This may be caused by a plugin contributed by one of these extensions: ${pluginExtensionList}` : "The JS/TS language service crashed 5 times in the last 5 Minutes."
  ...
  toPath(uri) {
    return this.toTsFilePath(import_coc44.Uri.parse(uri));
  }
  ...
  toResource(filepath) {
    ...
    if (filepath.startsWith(inMemoryResourcePrefix)) {
      ...
      if (parts) {
        ...
        let resource = import_coc44.Uri.parse(parts[1] + "://" + (parts[2] === emptyAuthority ? "" : parts[2]) + "/" + parts[3]);
